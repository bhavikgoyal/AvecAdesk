...
builder.Services.AddScoped<IAccountingPaymentReminderRepository, AccountingPaymentReminderRepository>();
builder.Services.AddScoped<AccountingPaymentReminderService>();
builder.Services.AddHostedService<AccountingPaymentReminderBackgroundService>();
